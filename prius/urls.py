...
urlpatterns = [
    ...
    path('password_reset/', auth_views.PasswordResetView.as_view(form_class=app.forms.CrispyPasswordReset), name='password_reset'),
    path('password_reset/done/', auth_views.PasswordResetDoneView.as_view(), name='password_reset_done'),
    path('reset/<uidb64>/<token>/', auth_views.PasswordResetConfirmView.as_view(form_class=app.forms.CrispySetPassword), name='password_reset_confirm'),
    ...
    path('resend/<userpk>/', app.views.resend, name='resend'),
    path('activate/<uidb64>/<token>/', app.views.activate, name='activate'),
